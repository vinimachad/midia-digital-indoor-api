import GetWeatherCityByIdUseCase, { IGetWeatherCityByIdUseCase, WeatherRequest } from './get-weather-city-by-id'
...
export default class GetWeatherCitiesUseCase implements IGetWeatherCitiesUseCase {
  private cities: CitiesIds[] = Object.values(CitiesIds)
  constructor(private getWeatherCityByIdUseCase: IGetWeatherCityByIdUseCase = new GetWeatherCityByIdUseCase()) {}
